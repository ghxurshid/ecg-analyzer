...
import com.scichart.examples.fragments.showcase.vitalSignsMonitor.VitalSignsData;
...
public abstract class DataProviderBase<E> implements IDataProvider<E> {
    ...
    public DoubleRange getEcgHeartRateRange() {
        return new DoubleRange();
    }

    public DoubleRange getBloodPressureRange() {
        return new DoubleRange();
    }

    public DoubleRange getBloodVolumeRange() {
        return new DoubleRange();
    }

    public DoubleRange getBloodOxygenationRange() {
        return new DoubleRange();
    }
    ...
    protected abstract boolean canCantinue(E item);
}

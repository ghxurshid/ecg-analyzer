...
public class VitalSignsData {
    ...
    public VitalSignsData(double xValue, double ecgHeartRate, double bloodPressure, double bloodVolume, double bloodOxygenation, boolean isATrace, boolean isValid) {
        this.xValue = xValue;
